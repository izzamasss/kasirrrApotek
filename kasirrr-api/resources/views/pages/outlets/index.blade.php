                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href='{{ route('outlets.index', 'outlet_id=' . $outlet->id) }}'
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('outlets-users.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                <select
                                                    class="form-control selectric @error('user_id') is-invalid @enderror"
                                                    name="user_id">
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($outletsUsers as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <form action="{{ route('outlets-users.destroy', $user->id) }}"
                                                            method="POST" class="ml-2">
                                                            <input type="hidden" name="_method" value="DELETE" />
                                                            <input type="hidden" name="_token"
                                                                value="{{ csrf_token() }}" />
